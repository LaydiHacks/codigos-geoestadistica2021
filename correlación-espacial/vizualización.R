...
setwd("D:/CARLOS/Econometria Espacial/Doctorado Economía UN/Econometria Espacial Polonia")
...
# Mapa de importación 1 - nivel de pobreza, proyección correcta (source: Centro Central de Documentación Geodésica y Cartográfica, 
# http://www.codgik.gov.pl/index.php/darmowe-dane/prg.html)
mapa1 <- readOGR(".", "powiaty")
# Este mapa es preciso y está bien descrito, pero las coordenadas están codificadas de una manera diferente a la que necesitamos.
# Deberíamos recalcularlos en grados de longitud y latitud.
mapa1 <- spTransform(mapa1, "+proj=longlat")
plot(mapa1)

# Mapa de importación 2: muchos niveles y países a la vez
...
plot(mapa2)
# Seleccionamos Polonia, Francia, España, Alemania, Reino Unido o el país que deseen 
...
plot(mapaRO)
# Fronteras más amplias de áreas administrativas
...
writeOGR(mapaRON2,"D:/CARLOS/Econometria Espacial/Doctorado Economía UN/Parciales/Romania",layer="Romania.N2",driver="ESRI Shapefile")

Romania <- readOGR("D:/CARLOS/Econometria Espacial/Doctorado Economía UN/Parciales/Romania/Romania.N2.shp")
par(mai=c(0,0,0,0))
plot(Romania)
...
writeOGR(mapaUKN1,"D:/CARLOS/Econometria Espacial/Doctorado Economía UN/Parciales/UK",layer="UK.N1",driver="ESRI Shapefile")


UK.N1 <- readOGR("D:/CARLOS/Econometria Espacial/Doctorado Economía UN/Parciales/UK/United_Kingdom.N1.shp")
plot(UK.N1)
...
#mapa de importación 3 - formato R (rds; fuente: gadm.org)
mapa3 <- readRDS("POL_adm2.rds")
plot(mapa3)

#En última instancia, utilizamos el mapa de poviats proporcionado por CODGiK:
mapa <- mapa1
...
#Ponga las bases de datos espaciales y económicas juntas, elimine las bases de datos parciales
